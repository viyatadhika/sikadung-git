...
elseif ($module=='kerusakan' AND $act=='input'){
  ...
  if ($file_extension=='php'){
   echo "<script>window.alert('Upload Gagal, Pastikan File yang di Upload tidak bertipe *.PHP');
    ...
    mysql_query("INSERT INTO kerusakan(nomor_kerusakan, tgl_kerusakan, pelapor, id_gedung, id_jenis_kerusakan, lokasi_kerusakan, keterangan_kerusakan, nama_file) 
                            VALUES('$_POST[nomor_kerusakan]',
                                   '$_POST[tgl_kerusakan]',
                                   '$_POST[pelapor]',
                                   '$_POST[gedung]',
  ...
  header('location:../../media.php?module='.$module);
    ...
    mysql_query("INSERT INTO kerusakan(nomor_kerusakan, tgl_kerusakan, pelapor, id_gedung, id_jenis_kerusakan, lokasi_kerusakan, keterangan_kerusakan) 
                            VALUES('$_POST[nomor_kerusakan]', 
                                  '$_POST[tgl_kerusakan]',
                                  '$_POST[pelapor]',
                                  '$_POST[gedung]',
...
elseif ($module=='kerusakan' AND $act=='update'){
  ...
  if (empty($lokasi_file)){
    mysql_query("UPDATE kerusakan SET tgl_kerusakan       = '$_POST[tgl_kerusakan]',
                                ...
                                id_jenis_kerusakan   = '$_POST[jenis_kerusakan]',
