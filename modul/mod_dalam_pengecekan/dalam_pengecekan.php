...
<center>Untuk mengakses modul, Anda harus login <br>";
 echo "<a href=../../index.php><b>LOGIN</b></a></center>";
  ...
  $excel="modul/mod_dalam_pengecekan/exceldalampengecekan.php";
  echo "
    ...
    <div class='row pulse animated'>
        <div class='col-xs-12'>
          ...
          <div class='box-header with-border'>
            <center><h3 class='box-title'>Daftar Kerusakan Yang Dalam Pengecekan</h3></center>
        </div>
        <div class='box-body'>
