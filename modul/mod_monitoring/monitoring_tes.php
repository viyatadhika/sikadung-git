...
$bast="modul/mod_monitoring/cetak_bast_kerusakan.php";
        ...
        <div class='col-xs-12'>
          <div class='box'>
            ...
            <tr>";
              ...
              echo" <td><b>Total Kerusakan</b></td>";
              if ($_GET[tgl_sampai] == null) {
                echo "<td><span class='label label-danger'> - </b></td>";
              } else {
                echo "<td><b>$count_total</b></td>";	
              }
            echo"  
            </tr>
            <tr>
              <td><b>Selesai Perbaikan</b></td>";
              if ($_GET[tgl_sampai] == null) {
                echo "<td><span class='label label-danger'> Data Belum Diisi </b></td>";
              } else {
                echo "<td><b>$tglsampai</b></td>";	
