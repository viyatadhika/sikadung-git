...
<center>Untuk mengakses modul, Anda harus login <br>";
 echo "<a href=../../index.php><b>LOGIN</b></a></center>";
  ...
  $excel="modul/mod_dalam_pengerjaan/exceldalampengerjaan.php";
  echo "
    ...
    <div class='row pulse animated'>
        <div class='col-xs-12'>
          ...
          <div class='box-header with-border'>
            <center><h3 class='box-title'>Daftar Kerusakan Yang Dalam Pengerjaan</h3></center>
        </div>
        <div class='box-body'>
